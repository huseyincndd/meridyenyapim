  ...
  return (
    <section id="surec" className="relative mx-auto max-w-7xl px-6 py-24 md:py-32">
      ...
      <ol className="relative grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-5">
        {steps.map((s, i) => (
          <FadeIn key={s.n} delay={i * 100} className="flex">
            <li
              className={`group relative w-full overflow-hidden rounded-3xl border border-border p-6 transition-all duration-500 hover:-translate-y-2 hover:border-primary/50 hover:shadow-[0_20px_40px_-15px_rgba(162,255,50,0.15)] ${
